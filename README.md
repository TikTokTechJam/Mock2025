...
PostgreSQL-backed Docker Compose topology. HTTP media ingestion, server-side or
production transport, cross-modal redaction, persistence, and creator controls
